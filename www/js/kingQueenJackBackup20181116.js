...
function shuffle() {
	...
	for (i = 0 ; i < 52; i++) {
		...
		// var cardPos = Math.floor(Math.random() * (max - min + 1) ) + min;
...
function drawCardNum() {
	...
	graveyardDeck.push(drawnCard);
	//displayCard = cardFace[drawncard[1]] + " of " + suitName[drawncard[0]];
...
function clickKing(){
	shuffleNum();
	document.getElementById("display").innerHTML = "First to draw a King wins";
...
function clickQueen(){	
	shuffleNum();
	document.getElementById("display").innerHTML = "First to draw a Queen wins";
	document.getElementById("drawer").disabled = false;
...
function clickJack(){
	shuffleNum();
	document.getElementById("display").innerHTML = "First to draw a Jack wins";
	document.getElementById("drawer").disabled = false;
